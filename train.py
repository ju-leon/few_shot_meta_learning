...
def main():
    ...
    parser.add_argument("--num_models", default=16, type=int)
    ...
    parser.add_argument("--num_episodes_per_epoch", default=8, type=int)
    parser.add_argument("--minibatch", default=8, type=int)
    parser.add_argument("--points_per_minibatch", default=16,  type=int)
    parser.add_argument("--minbatch_test", default=128, type=int)
    parser.add_argument("--points_per_minibatch_test", default=128, type=int)
    parser.add_argument("--minibatch_print", default=1, type=int)
    parser.add_argument('--first-order', dest='first_order',
                        action='store_true')
    ...
    parser.add_argument("--normalize_bm", default=True, type=bool)
    parser.add_argument("--n_points_pred", default=100, type=int)
